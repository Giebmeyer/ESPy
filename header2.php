            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            if ($_SESSION['usuario_chefe'] == 1 || $_SESSION['usuario_empregado'] == 1) {
                                ...
                                echo ('<li><a class="dropdown-item" href="../../ESPy_Web/Paginas/Empresa/funcionarios_Page.php">Funcionários</a></li>');
                            }

                            ?>

                            <li><a class="dropdown-item" href="../../ESPy_Web/Paginas/Empresa/minhaEmpresa_Page.php">Cadastro</a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link" href="ESPy_logoff.php?sair=true">Sair</a>
