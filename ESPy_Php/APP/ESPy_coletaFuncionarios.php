<?php 
    ...
    $return["sucessoRequestFuncionarios"] = false;
		...
		$query = "SELECT u.* FROM usuarios u JOIN usuarios_empresas ue ON u.codigo = ue.codigo_usuario JOIN empresas e ON e.codigo = ue.codigo_empresa WHERE ue.codigo_empresa = '$codigoEmpresa' AND u.usuario_chefe != 1 AND ue.saiuEmpresa = 'A' ORDER BY `data_hora_cadastro` desc";	 
