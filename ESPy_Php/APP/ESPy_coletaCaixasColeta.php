<?php 
    ...
    $return["sucessoRequestFuncionarios"] = false;
		...
		$query = "Select cc.*, IFNULL((select d.IDK as idk from dados d where cc.codigo = d.codigo_caixa order by sequencia desc limit 1), 0) as IDK from caixas_coleta cc join empresas e On e.codigo = cc.codigo_empresa WHERE e.codigo = 108 AND cc.excluida != 1 ORDER BY order by codigo desc;";	 
